  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="w-full max-w-md rounded-lg border border-zinc-800 bg-zinc-900 p-5">
        <h2 className="text-base font-semibold text-zinc-100">Claude API key</h2>
        <p className="mt-1 text-xs text-zinc-400">
          The Socratic Assistant calls Claude directly from your browser using this key. It's stored only in this
          browser's localStorage and never sent anywhere except Anthropic's API.
        </p>
        <input
          type="password"
          value={value}
